...
class mapApp24 extends StatefulWidget {
  @override
  _mapAppState createState() => _mapAppState();
}

class _mapAppState extends State<mapApp24> {
  ...
  readcsv() async{
    String data= await getFileData("assets/grooming.csv");
