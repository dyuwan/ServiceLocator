...
class mapApp27 extends StatefulWidget {
  @override
  _mapAppState createState() => _mapAppState();
}

class _mapAppState extends State<mapApp27> {
  ...
  readcsv() async{
    String data= await getFileData("assets/plumbers.csv");
