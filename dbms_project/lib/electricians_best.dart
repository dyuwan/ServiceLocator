...
class mapApp23 extends StatefulWidget {
  @override
  _mapAppState createState() => _mapAppState();
}

class _mapAppState extends State<mapApp23> {
  ...
  readcsv() async{
    String data= await getFileData("assets/electricians.csv");
        ...
        if (dist[i] < 6 && price[i]<200) {
          final mark = Marker(
            ...
            infoWindow: InfoWindow(
              title: name[i],
              snippet: "Dist: ${dist[i]} km Price: ${price[i]}",
            ),
          );
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('Electricians Best Map'),
