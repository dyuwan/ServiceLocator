...
class mapAppE extends StatefulWidget {
  @override
  _mapAppState createState() => _mapAppState();
}

class _mapAppState extends State<mapAppE> {
  ...
  Future<void> _onMapCreated(GoogleMapController controller) async {
    ...
    setState(() {
      ...
      for(int i=0; i<55; i++){
        ...
        else if(price[i]>=200 && price[i]<250){
          final mark = Marker(
            icon: BitmapDescriptor.defaultMarkerWithHue(
