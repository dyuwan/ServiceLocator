...
class mapApp20 extends StatefulWidget {
  @override
  _mapAppState createState() => _mapAppState();
}

class _mapAppState extends State<mapApp20> {
  ...
  readcsv() async{
    String data= await getFileData("assets/ac_repair.csv");
